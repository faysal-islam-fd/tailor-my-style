...
export default function QualitySection({ language = 'en' }: QualitySectionProps) {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-background to-secondary relative overflow-hidden">
      {/* Decorative background */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-primary rounded-full blur-3xl opacity-5"></div>
