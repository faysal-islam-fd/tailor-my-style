...
export default function HighTechTailoring({ language = 'en' }: HighTechTailoringProps) {
  ...
  return (
    <section className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-accent rounded-full blur-3xl opacity-5"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary rounded-full blur-3xl opacity-5"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Left - Content */}
          <div className="animate-fade-in">
            <div className="inline-block px-4 py-2 bg-primary/15 border border-primary/30 text-primary rounded-full text-sm font-bold mb-6">
              Technology Meets Tradition
            </div>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-400 bg-clip-text  mb-6 leading-tight">
